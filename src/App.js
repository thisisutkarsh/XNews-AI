...
const App = () => {
  ...
  function countryFilter(event) {
    ...
    alanInstance.callProjectApi(
      "script::countryFilter",
      { data: countryRef.current.value },
  ...
  function languageFilter(event) {
    ...
    alanInstance.callProjectApi(
      ...
      { data: languageRef.current.value },
      function (error, result) {}
    );
  }
  ...
  return (
    <div className="app__main">
      <div className="app__innerContainer">
        <h1 className="h-text">
          Ask <span>News</span> That Interests you{" "}
        </h1>
        <div className="app__cardsFilter">
          ...
          <div className="app__filterCard">
            <label htmlFor="countrySel" className="label-1">
              Country
            </label>
            <select
              id="countrySel"
            ...
            >
              {country.map((each, index) => (
                <option key={`${each}${index}`}>{each}</option>
              ))}
            </select>
            <label htmlFor="languageSel" className="label-1">
              Language
            </label>
            <select
              id="languageSel"
            ...
            <label htmlFor="fromInput" className="label-1">
              From
            </label>
            <input
              onChange={fromTime}
              ...
              type="Date"
            ></input>
            <label htmlFor="toInput" className="label-1">
              To
            </label>
            <input
              onChange={toTime}
              ...
              type="Date"
            ></input>
            <label htmlFor="sortEl" className="label-1">
              Sort By
            </label>
            <select
              id="sortEl"
